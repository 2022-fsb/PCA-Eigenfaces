...
class FaceRecognition(object):
    ...
    def __init__(self, image_path=Data_Dir, suffix="*.pgm", variance_pct=0.80, knn=5):  # load images
        ...
        for idx, image_name in enumerate(image_names):
            ...
            self.image_story.append((image_name, img, self.get_label(image_name)))
...
# -----------------------------------------------------------------------------------------------------
    def get_label(self, fileName, lastSubdir=True):
        if lastSubdir:
